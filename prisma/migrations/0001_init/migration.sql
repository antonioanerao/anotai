...
-- CreateEnum
CREATE TYPE "EditMode" AS ENUM ('OWNER_ONLY', 'COLLABORATIVE');
...
CREATE TABLE "Pad" (
    ...
    "editMode" "EditMode" NOT NULL DEFAULT 'OWNER_ONLY',
...
-- AddForeignKey
ALTER TABLE "Pad" ADD CONSTRAINT "Pad_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
